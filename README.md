...
правок. Вбудовані як приклади: **«Астероїди»** з чотирма модулями через
`require` і шістнадцятьма ресурсами, офіційний `examples/LUA/cat`, ігри
«Кубики» та «Повтори комбінацію» зі спільноти.
